...
class Start:
    ...
    def run(self):
        ...
        #Boton Start
        login_button_rect = pygame.Rect(225, 150, 415, 55)
        login_text = font.render('Empezar carrera', True, color_font)
        #Boton Quit
        quit_button_rect = pygame.Rect(375, 250, 120, 55)
        ...
        if login_button_rect.x <= a <= login_button_rect.x+415 and login_button_rect.y <= b <= login_button_rect.y+55:
